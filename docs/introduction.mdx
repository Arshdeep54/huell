...
<Note>
  Huell targets a much smaller, more common case: a small team with docs content (MDX + a nav config) who wants it built and served without a vendor contract or that much infrastructure.
</Note>
